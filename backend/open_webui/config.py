...
frontend_favicon = FRONTEND_BUILD_DIR / "static" / "PXL-logo.png"

if frontend_favicon.exists():
    try:
        shutil.copyfile(frontend_favicon, STATIC_DIR / "PXL-logo.png")
    except Exception as e:
        logging.error(f"An error occurred: {e}")
        ...
        if r.ok:
            if "logo" in data:
                ...
                if r.status_code == 200:
                    with open(f"{STATIC_DIR}/PXL-logo.png", "wb") as f:
...
DEFAULT_ARENA_MODEL = {
    ...
    "name": "Arena Model",
    "meta": {
        "profile_image_url": "/PXL-logo.png",
